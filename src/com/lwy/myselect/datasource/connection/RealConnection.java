...
import com.lwy.myselect.datasource.statement.RealPreparedStatement;
...
class RealConnection implements ConnectionWrapper{
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        ...
        realPreparedStatement = new RealPreparedStatement(statement,this);
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        return realPreparedStatement
                = new RealPreparedStatement(physicalConnection.prepareStatement(sql,resultSetType,resultSetConcurrency),this);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return realPreparedStatement =
                new RealPreparedStatement(physicalConnection.prepareStatement(sql,resultSetType,resultSetConcurrency
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        return realPreparedStatement
                = new RealPreparedStatement(physicalConnection.prepareStatement(sql,autoGeneratedKeys),this);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return realPreparedStatement
                = new RealPreparedStatement(physicalConnection.prepareStatement(sql,columnIndexes),this);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return realPreparedStatement
                = new RealPreparedStatement(physicalConnection.prepareStatement(sql,columnNames),this);
    }
